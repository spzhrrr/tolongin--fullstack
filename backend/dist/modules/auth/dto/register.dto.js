...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Andi Pratama', minLength: 3, maxLength: 100 }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'andi@tolongin.com' }),
...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^(?=.*\d)(?=.*[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]).+$/, {
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^(\+62|62|0)8[1-9][0-9]{7,11}$/, {
