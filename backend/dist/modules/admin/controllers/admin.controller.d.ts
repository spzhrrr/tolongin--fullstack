...
export declare class AdminController {
    ...
    suspend(id: string, admin: string): Promise<{
        message: string;
    }>;
    activate(id: string, admin: string): Promise<{
        message: string;
    }>;
    ...
    approveSeller(id: string, admin: string): Promise<{
        message: string;
    }>;
    rejectSeller(id: string, admin: string, dto: RejectSellerDto): Promise<{
        message: string;
    }>;
    ...
    deleteService(id: string, admin: string): Promise<{
        message: string;
    }>;
    ...
    deleteJob(id: string, admin: string): Promise<{
        message: string;
    }>;
    ...
    resolveDispute(id: string, admin: string, body: {
        resolution: string;
    }): Promise<any>;
    ...
    updateSettings(dto: UpdateSettingsDto, admin: string): Promise<Record<string, string>>;
}
