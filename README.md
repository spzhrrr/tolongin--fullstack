...
Masalah: Can't reach database
Solusi: Pastikan MySQL running (sudo systemctl start mysql)

Masalah: Prisma migrate gagal
Solusi: Hapus folder prisma/migrations, lalu npx prisma migrate dev --name init

Masalah: Port 3000/8001 already in use
Solusi: Ganti port di .env masing-masing

Masalah: WebSocket connection failed
Solusi: Pastikan VITE_WS_URL sesuai dengan endpoint backend

Masalah: CORS error
Solusi: Periksa app.enableCors() di main.ts
